...
JqueryFileUploadMiddleware.prototype.fileHandler = function (redir, options) {
    return require('./lib/filehandler')(this, this.prepareOptions(_.extend(this.options, options)), redir);
};
